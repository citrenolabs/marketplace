...
from ..core.constants import (
    ...
    RESULT_VALUE_FALSE,
    RESULT_VALUE_TRUE,
    UPDATE_RPZ_CNAME_RULE_SCRIPT_NAME,
)
...
def main():
    ...
    siemplify.script_name = UPDATE_RPZ_CNAME_RULE_SCRIPT_NAME
    ...
    rule_type = extract_action_param(
        ...
        is_mandatory=False,
        print_value=True,
        default_value="Block (No such Domain)",
    )
    ...
    try:
        ...
        result = api_manager.update_rpz_cname_rule(
            reference_id,
            rule_type,
            name,
            rp_zone,
        ...
        if result:
            ...
            output_message = f"Updated RPZ CNAME rule {reference_id}."

        else:
            result_value = RESULT_VALUE_FALSE
            output_message = "Failed to update RPZ CNAME rule."
        ...
        output_message = COMMON_ACTION_ERROR_MESSAGE.format(
            UPDATE_RPZ_CNAME_RULE_SCRIPT_NAME, str(e)
        )
        result_value = RESULT_VALUE_FALSE
        siemplify.LOGGER.error(output_message)
        siemplify.LOGGER.exception(e)
