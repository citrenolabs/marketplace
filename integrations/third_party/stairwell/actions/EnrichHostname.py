...
def main():
    ...
    suitable_entities = [
        entity for entity in siemplify.target_entities if entity.entity_type == EntityTypes.HOSTNAME
    ]
    ...
    try:
        ...
        for entity in suitable_entities:
            ...
            try:
                ...
                entity.is_suspicious = manager.parser.is_entity_suspicious(entity_report)
        ...
        if json_results:
            logger.info("___RESULTS___")
            logger.info(convert_dict_to_json_result_dict(json_results))
