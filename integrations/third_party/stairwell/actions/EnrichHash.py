    ...
    try:
        ...
        for entity in suitable_entities:
            ...
            if unix_now() >= siemplify.execution_deadline_unix_time_ms:
                deadline = convert_unixtime_to_datetime(siemplify.execution_deadline_unix_time_ms)
                siemplify.LOGGER.error(f"Timed out. Execution deadline ({deadline}) has passed")
